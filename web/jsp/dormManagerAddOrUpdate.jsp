        ...
        <div class="data_form">
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td><input type="password" id="rPassword" name="rPassword" value=""
                               style="margin-top:5px;height:30px;"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="tel" name="tel" value="${user.tel}" style="margin-top:5px;height:30px;"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <c:forEach items="${builds}" var="build">
                            <input name="dormBuildId" value="${build.id}" style="heigth:14px;vertical-align:top"
                                   type="checkbox">
                            ${build.name}  &nbsp;
                        </c:forEach>
                    </td>
