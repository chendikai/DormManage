...
public class LoginFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if(user != null) {
            ...
            Cookie cookie = CookieUtils.getCookieByName(httpServletRequest, "cookie_name_pass");
            ...
            if(cookie != null) {
                ...
                //判断当前用户的学号和密码是否有效
                User user2 = userService.findUserByStuCodeAndPass(stuCodePass2[0], stuCodePass2[1]);
